<template>
  ...
  <view class="diy-goods">
    <view class="goods-list display__list column__1">
      <scroll-view :scroll-x="false">
        <view class="goods-item" v-for="dataItem in dataList" :key="dataItem.goods_id" @click="onTargetGoods(dataItem.goods_id)">
              ...
              <view class="goods-item_right">
                ...
                <view class="goods-item_desc">
                  ...
                  <view class="desc_footer">
                    ...
                    <text class="price_y col-9" v-if="dataItem.line_price_min > 0">
